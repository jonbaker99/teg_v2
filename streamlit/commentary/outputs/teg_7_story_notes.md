...
- Round volatility: HM's R2 51pts peak, R4 38pts valley (14-point swing); JB's disasters H10-H11 R4
...
- H2: Jon BAKER disaster (+4 vs par), lost lead (both Gross and Stableford)
...
- H8: Henry MELLER disaster (+4 vs par), 0 pts, lost lead (Stableford)
...
### Cold Spells (Gross)
- Alex BAKER holes 3-5: Avg +2.33 vs par (disaster on H5)
- Alex BAKER holes 4-6: Avg +3.00 vs par (disaster on H5)
- Alex BAKER holes 5-7: Avg +3.00 vs par (disaster on H5)
- Alex BAKER holes 8-10: Avg +3.00 vs par (disaster on H10)
- Alex BAKER holes 9-11: Avg +3.00 vs par (disaster on H10)
- Alex BAKER holes 13-15: Avg +2.33 vs par (disaster on H14)
- Alex BAKER holes 14-16: Avg +2.67 vs par (disaster on H14)
- Alex BAKER holes 1-6: Avg +2.33 vs par (disaster on H5)
- Alex BAKER holes 4-9: Avg +2.50 vs par (disaster on H5)
- Alex BAKER holes 5-10: Avg +3.00 vs par (disasters on H5, H10)
- Alex BAKER holes 6-11: Avg +2.50 vs par (disaster on H10)
- Alex BAKER holes 9-14: Avg +2.33 vs par (disasters on H10, H14, 4 points on H12)
- Henry MELLER holes 6-8: Avg +2.33 vs par (disaster on H8)
...
### Cold Spells (Gross)
- Alex BAKER holes 1-3: Avg +2.33 vs par (disaster on H1)
- Alex BAKER holes 14-16: Avg +2.67 vs par
- Gregg WILLIAMS holes 13-15: Avg +2.67 vs par (disaster on H15)
- Gregg WILLIAMS holes 14-16: Avg +3.00 vs par (disaster on H15)
- Gregg WILLIAMS holes 15-17: Avg +2.67 vs par (disaster on H15)
...
- H13: Stuart NEUMANN birdie (bounced back after consecutive disasters)
- H14: Henry MELLER 4 points on H14 - regained gross lead
- H15: David MULLIN disaster (quintuple bogey) - lost gross lead
- H15: Gregg WILLIAMS 4 points on H15
- H17: Henry MELLER disaster - lost gross lead
...
### Cold Spells (Net)
- Henry MELLER holes 15-17: 1 pt (disasters on H15, H17)

### Cold Spells (Gross)
- Jon BAKER holes 1-3: Avg +3.33 vs par (disasters on H2, H3)
- Jon BAKER holes 2-4: Avg +3.33 vs par (disasters on H2, H3)
- Jon BAKER holes 1-6: Avg +2.33 vs par (disasters on H2, H3)
- Alex BAKER holes 4-6: Avg +2.67 vs par (disaster on H6)
- Gregg WILLIAMS holes 13-18: Avg +2.50 vs par (disasters on H13, H14)
- Henry MELLER holes 15-17: Avg +2.67 vs par (disasters on H15, H17)
- David MULLIN holes 13-15: Avg +3.00 vs par (disasters on H13, H15)
- Stuart NEUMANN holes 10-12: Avg +2.67 vs par (disasters on H11, H12)
...
### Key Moments
- H1: Jon BAKER disaster (triple bogey or worse, +3 vs par, 0 pts) - dropped from rank 3 to 4
- H1: Alex BAKER disaster (triple bogey or worse, +3 vs par)
- H2: Stuart NEUMANN birdie (4 points)
- H3: Alex BAKER disaster (quadruple bogey, +4 vs par, 0 pts)
- H6: Alex BAKER disaster (quintuple bogey or worse, +5 vs par, 0 pts)
- H7: Stuart NEUMANN birdie (4 points)
- H9: Henry MELLER disaster (quadruple bogey, +4 vs par, 0 pts)
- H10: Jon BAKER disaster (sextuple bogey or worse, +6 vs par, 0 pts) - dropped from rank 2 to 3
- H10: David MULLIN disaster (triple bogey, +3 vs par, 0 pts) - dropped from rank 1 to 3 gross
- H10: Alex BAKER disaster (triple bogey, +3 vs par)
- H10: Gregg WILLIAMS 4 points on H10 - moved from rank 5 to 2 Stableford
- H11: David MULLIN birdie (4 points)
- H11: Jon BAKER disaster (quadruple bogey, +4 vs par, 0 pts)
- H14: Alex BAKER birdie (5 points)
- H16: Alex BAKER disaster (quintuple bogey or worse, +5 vs par, 0 pts)
- H17: David MULLIN birdie (5 points)
- H18: Henry MELLER disaster (triple bogey, +3 vs par, 0 pts) - dropped from rank 2 to 3 gross but maintained Stableford lead
...
### Cold Spells (Gross)
- Jon BAKER holes 8-10: Avg +2.33 vs par (disaster on H10)
- Jon BAKER holes 9-11: Avg +3.67 vs par (disasters on H10, H11)
- Jon BAKER holes 10-12: Avg +3.67 vs par (disasters on H10, H11)
- Alex BAKER holes 1-3: Avg +2.67 vs par (disaster on H3)
- Alex BAKER holes 2-4: Avg +2.33 vs par (disaster on H3)
- Alex BAKER holes 3-5: Avg +2.33 vs par (disaster on H3)
- Alex BAKER holes 4-6: Avg +2.67 vs par (disaster on H6)
- Alex BAKER holes 5-7: Avg +3.00 vs par (disaster on H6)
- Alex BAKER holes 6-8: Avg +2.67 vs par (disaster on H6)
- Alex BAKER holes 15-17: Avg +2.33 vs par (disaster on H16)
- Alex BAKER holes 16-18: Avg +3.00 vs par (disaster on H16)
- Alex BAKER holes 1-6: Avg +2.67 vs par (disasters on H3, H6)
- Alex BAKER holes 2-7: Avg +2.67 vs par (disasters on H3, H6)
- Alex BAKER holes 3-8: Avg +2.50 vs par (disasters on H3, H6)
- Alex BAKER holes 5-10: Avg +2.33 vs par (disaster on H6)
- Henry MELLER holes 7-9: Avg +2.33 vs par (disaster on H9)
