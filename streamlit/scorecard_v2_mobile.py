...
# Tab 2: Tournament View (using mobile function)
    ...
    if len(tournament_data) == 0:
        ...
        # Generate tournament view using mobile function
...
# Tab 3: Round Comparison (using mobile function)
    ...
    if len(comparison_data) == 0:
        ...
        # Generate round comparison view using mobile function
